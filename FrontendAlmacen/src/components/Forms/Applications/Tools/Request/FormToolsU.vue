    ...
    <form>
        <FormField name="Username">
            <FormItem>
                ...
                <div class="p-1.5">
                    <FormLabel class="text-24 font-sans font-bold p-1.5">Almacen *</FormLabel>
                    <Select>
                        <SelectTrigger class="w-50">
                            <SelectValue placeholder="Almacén" class="text-12 font-sans font-light" />
                        </SelectTrigger>
                        <SelectContent>
                ...
                <div class="p-1.5">
                    ...
                    <FormControl>
                        <Textarea type="text" placeholder="Descripción" class="w-50 font-sans text-12 font-light my-3 h-25"></Textarea>
                    </FormControl>
                </div>
            </FormItem>
        </FormField>
