        ...
        <FormField name="Collaboratorname">
            <FormItem>
                <div class="flex justify-center p-1.5">
                    ...
                    <FormControl>
                        <Input v-model="id_Collaborator" placeholder="Ingrese el ID"
                ...
                <div class="flex p-1.5">
                    <div class="p-1.5">
                        ...
                        <FormControl>
                            <Input v-model="name" placeholder="Ingrese el nombre"
                    ...
                    <div class="p-1.5">
                        ...
                        <FormControl>
                            <Input v-model="last_name" placeholder="Ingrese el apellido"
                                class="w-50 text-12 font-sans font-light" />
                        </FormControl>
                    </div>
                </div>
                        ...
                        <Select v-model="company">
                            ...
                            <SelectContent>
                                <SelectItem v-for="company in props.companies" :key="company.id_Company"
                                    :value="company.id_Company" class="w-50">
                                    {{ company.name }}
                                </SelectItem>
                            </SelectContent>
                        </Select>
