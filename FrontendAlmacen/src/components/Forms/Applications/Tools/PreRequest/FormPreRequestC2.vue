...
import { TypeStore } from '../../../../data/TypeStore';
        ...
        <FormField name="Toolname3">
            <FormItem>
                ...
                <div class="p-1.5">
                    ...
                    <FormControl>
                        <Textarea v-model="props.description" type="text" placeholder="Ingrese una descripción" class="w-50 font-sans text-12 font-light my-3 h-25"></Textarea>
                    </FormControl>
                </div>
            </FormItem>
        </FormField>
