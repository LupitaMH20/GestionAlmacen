        ...
        <FormField name="Articlename">
            <FormItem>
                <div class="p-1.5">
                    ...
                    <FormControl>
                        <Input type="text" placeholder="Ingrese el idProductoPrincipal" class="w-50 font-sans text-12 font-light" />
                    </FormControl>
                </div>
                <div class="p-1.5">
                    <FormLabel class="text-24 font-sans font-bold p-1.5">ID Producto Alternativo *</FormLabel>
                    <FormControl>
                        <Input type="text" placeholder="Ingrese el idProductoAlternatico" class="w-50 font-sans text-12 font-light" />
                    </FormControl>
                </div>
                <div class="p-1.5">
