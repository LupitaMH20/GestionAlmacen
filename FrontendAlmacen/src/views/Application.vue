        ...
        <div class="grid grid-cols-3 gap-6">
            ...
            <section class="bg-gray-50 p-3 rounded-lg min-h-[500px]">
                ...
                <div class="flex flex-col space-y-3">
                    ...
                    <p v-if="!consumibles.length" class="text-gray-500 text-sm italic mt-4">No hay solicitudes de
                        consumibles.</p>
                </div>
            </section>
            ...
            <section class="bg-gray-50 p-3 rounded-lg min-h-[500px]">
                ...
                <div class="flex flex-col space-y-3">
                    ...
                    <p v-if="!herramienta.length" class="text-gray-500 text-sm italic mt-4">No hay solicitudes de
                        herramienta.</p>
                </div>
            </section>
            ...
            <section class="bg-gray-50 p-3 rounded-lg min-h-[500px]">
                ...
                <div class="flex flex-col space-y-3">
                    ...
                    <p v-if="!consumoPersonal.length" class="text-gray-500 text-sm italic mt-4">No hay solicitudes de
                        consumo personal.</p>
                </div>
            </section>
