...
const props2 = defineProps<{
    company: Array<{ id_Company: string, name: string }>
        ...
        <FormField name="articlename">
            <FormItem>
                <div class="p-1.5">
                    ...
                    <FormControl>
                        <Input v-model="props.stock" type="number" />
                    </FormControl>
                </div>
                <div class="p-1.5">
                    <FormLabel>Precio *</FormLabel>
                    <FormControl>
                        <Input v-model="props.price" type="number" />
                    </FormControl>
                </div>
                <div class="p-1.5">
                ...
                <div class="p-1.5">
                    ...
                    <Select v-model="props.company">
                        ...
                        <SelectContent>
                            <SelectItem v-for="company in props2.company" :key="company.id_Company"
